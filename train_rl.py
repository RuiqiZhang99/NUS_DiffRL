...
def get_args(): # TODO: delve into the arguments
    task = 'cartpole_swing_up' # cartpole_swing_up ant hopper humanoid cheetah
    algo = 'ppo'
    custom_parameters = [
        {"name": "--test", "action": "store_true", "default": False,
            "help": "Run trained policy, no training"},
        {"name": "--num_envs", "type": int, "default": 0, "help": "Number of envirnments"},
        {"name": "--cfg", "type": str, "default": "./examples/cfg/{}/{}.yaml".format(algo, task),
        ...
        {"name": "--logdir", "type": str, "default": "logs/{}/{}/".format(task, algo)},
