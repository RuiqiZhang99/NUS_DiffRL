...
def get_args(): # TODO: delve into the arguments
    task = 'ant' # cartpole_swing_up ant hopper humanoid cheetah
    custom_parameters = [
        {"name": "--test", "action": "store_true", "default": False,
            "help": "Run trained policy, no training"},
        {"name": "--cfg", "type": str, "default": "./examples/cfg/shac/{}.yaml".format(task), 
        ...
        {"name": "--logdir", "type": str, "default": "logs/{}/shac/".format(task)},
