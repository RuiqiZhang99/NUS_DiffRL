...
def get_args(): # TODO: delve into the arguments
    task = 'snu_humanoid' # cartpole_swing_up ant hopper cheetah humanoid snu_humanoid
    custom_parameters = [
        {"name": "--test", "action": "store_true", "default": False,
            "help": "Run trained policy, no training"},
        {"name": "--cfg", "type": str, "default": "./examples/cfg/pit/{}.yaml".format(task), 
        ...
        {"name": "--logdir", "type": str, "default": "logs/{}/pit-iteration-2/".format(task)},
        ...
        {"name": "--seed", "type": int, "default": random.randint(0, 10000), "help": "Random seed"},
...
if __name__ == '__main__':
    for i in range(5):
        ...
        traj_optimizer = pit.PIT(cfg_train)
